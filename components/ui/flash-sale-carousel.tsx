        ...
        <div className="flex -ml-4">
          {items.map((item) => (
            ...
            >
              ...
              >
                <div className="w-full aspect-[4/5] p-3 relative bg-white flex items-center justify-center overflow-hidden">
                  <PixelImage
                    src={item.imageUrl}
                    alt={item.name}
                    className="w-full h-full bg-transparent"
                    imgClassName="max-w-full max-h-full object-contain group-hover:scale-105 transition-transform"
                  />
                </div>
