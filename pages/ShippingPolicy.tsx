      ...
      <div className="space-y-8 text-sm md:text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Standard Border Cross Delivery:</strong> 1 Month+ (approx 30 - 45 Business Days with dedicated international tracking)</li>
            <li><strong>Priority Clearance:</strong> Available for select verified electronics</li>
          </ul>
        </section>
